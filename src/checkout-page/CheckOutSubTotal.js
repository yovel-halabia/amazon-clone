...
import {getBasketTotal,getBasketLength} from '../Reducer';
...
const CheckOutSubTotal = () => {
    ...
    return (
        <div className="checkoutsubtotal">
            ...
            prefix={"$"}
            />
            <button disabled={basket.length == 0&& true} className={basket.length == 0? "app__button-disable":undefined} onClick={()=>{!user?showErrMsg(true):navigate('/payment')}}>Procced to Checkout</button>
