...
import {getBasketLength,getBasketTotal} from '../Reducer';
        ...
        <div className="payment">
            ...
            <div className="payment__section">
                ...
                <div className="payment__content">
                    ...
                    {errMssg != '' &&<span data-testid="errorMssg" className="payment__err-msg">{errMssg}</span>}
                    <button data-testid="paymentButton" className="payment__button" onClick={handlePayment} disabled={errMssg !=''?true:false}>Buy Now</button>
                </div>
            </div>
